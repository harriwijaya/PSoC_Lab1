...
extern "C" void poly (int x, int* y);
...
void poly (int x, int* y) {
    ...
    if (wrapc_switch_file_token.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc ) {
            ...
            if (i > 0) {
                ...
                for (int i_0 = 0; i_0 <= 0 ; i_0+= 1) {
                    ...
                    *(y) = (sc_bv<32>(y_pc_buffer[0 + AESL_i].range(31, 0))).to_uint64();
        ...
        x_tvin_wrapc_buffer.range(31, 0) = x;
        ...
        for (int i_0 = 0; i_0 <= 0 ; i_0+= 1) {
            ...
            y_tvout_wrapc_buffer[0 + AESL_i].range(31, 0) = *(y);
