; ModuleID = '/home/harri001/Lab20150323/poly_proj/solution_poly/.autopilot/db/a.g.1.bc'
...
define void @poly(i16 signext %x, i16* %y) nounwind uwtable {
  ...
  call void @llvm.dbg.value(metadata !{i16 %x}, i64 0, metadata !13), !dbg !14 ; [debug line = 1:17] [debug variable = x]
  call void @llvm.dbg.value(metadata !{i16* %y}, i64 0, metadata !15), !dbg !16 ; [debug line = 1:28] [debug variable = y]
  %tmp.1 = mul i16 %x, 3, !dbg !17                ; [#uses=1 type=i16] [debug line = 3:2]
  %tmp = add i16 %tmp.1, 2                        ; [#uses=1 type=i16]
  %tmp1 = mul i16 %tmp, %x                        ; [#uses=1 type=i16]
  %tmp.2 = add i16 %tmp1, 1, !dbg !17             ; [#uses=1 type=i16] [debug line = 3:2]
  store i16 %tmp.2, i16* %y, align 2, !dbg !17    ; [debug line = 3:2]
...
!14 = metadata !{i32 1, i32 17, metadata !5, null}
...
!18 = metadata !{i32 786443, metadata !5, i32 1, i32 31, metadata !6, i32 0} ; [ DW_TAG_lexical_block ]
