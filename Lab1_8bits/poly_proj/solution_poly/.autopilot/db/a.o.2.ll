...
define void @poly(i8 signext %x, i8* %y) nounwind uwtable {
  call void (...)* @_ssdm_op_SpecBitsMap(i8 %x) nounwind, !map !13
  call void (...)* @_ssdm_op_SpecBitsMap(i8* %y) nounwind, !map !19
  call void (...)* @_ssdm_op_SpecTopModule([5 x i8]* @str) nounwind
  call void @llvm.dbg.value(metadata !{i8 %x}, i64 0, metadata !25), !dbg !26 ; [debug line = 1:16] [debug variable = x]
  call void @llvm.dbg.value(metadata !{i8* %y}, i64 0, metadata !27), !dbg !28 ; [debug line = 1:25] [debug variable = y]
  %_shl = shl i8 %x, 2, !dbg !29                  ; [#uses=1 type=i8] [debug line = 3:2]
  %tmp.1 = sub i8 %_shl, %x, !dbg !29             ; [#uses=1 type=i8] [debug line = 3:2]
  %tmp = add i8 %tmp.1, 2                         ; [#uses=1 type=i8]
  %tmp1 = mul i8 %tmp, %x                         ; [#uses=1 type=i8]
  %tmp.2 = add i8 %tmp1, 1, !dbg !29              ; [#uses=1 type=i8] [debug line = 3:2]
  store i8 %tmp.2, i8* %y, align 1, !dbg !29      ; [debug line = 3:2]
...
!16 = metadata !{metadata !"x", metadata !17, metadata !"char"}
!17 = metadata !{metadata !18}
!18 = metadata !{i32 0, i32 0, i32 0}
!19 = metadata !{metadata !20}
!20 = metadata !{i32 0, i32 7, metadata !21}
!21 = metadata !{metadata !22}
!22 = metadata !{metadata !"y", metadata !23, metadata !"char"}
...
!26 = metadata !{i32 1, i32 16, metadata !5, null}
!27 = metadata !{i32 786689, metadata !5, metadata !"y", metadata !6, i32 33554433, metadata !10, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!28 = metadata !{i32 1, i32 25, metadata !5, null}
!29 = metadata !{i32 3, i32 2, metadata !30, null}
!30 = metadata !{i32 786443, metadata !5, i32 1, i32 28, metadata !6, i32 0} ; [ DW_TAG_lexical_block ]
