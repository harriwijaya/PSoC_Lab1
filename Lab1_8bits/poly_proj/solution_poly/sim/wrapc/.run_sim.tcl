...
set ::env(LD_LIBRARY_PATH) /opt/Xilinx/Vivado_HLS/2013.4/lnx64/tools/fpo_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /opt/Xilinx/Vivado_HLS/2013.4/lnx64/tools/opencv:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /opt/Xilinx/Vivado_HLS/2013.4/lnx64/tools/fft_v9_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /opt/Xilinx/Vivado_HLS/2013.4/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
...
upvar ::AESL_AUTOSIM::DirAutoSimRoot  DirAutoSimRoot
    ...
    set gWorkingDir             "../.."
    set constFileTvIn           "poly.autotvin.dat"
    set constFileTvOut          "poly.autotvout.dat"
    set constFileHdlTvIn        "poly.autohdltvin.dat"
    set constFileHdlTvOut       "poly.autohdltvout.dat"
    set gGateLevelSim           "0"
    set gAutowrap               "1"
    set gTool                   "modelsim"
