...
using namespace sc_dt;
   ...
   #define AUTOTB_TVOUT_PC_y  "../tv/rtldatafile/rtl.poly.autotvout_y.dat"
...
extern "C" void poly (char x, char* y);
#define poly AESL_ORIG_DUT_poly
extern "C" void poly (char x, char* y);
#undef poly
void poly (char x, char* y) {
    ...
    if (wrapc_switch_file_token.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc ) {
            ...
            sc_bv<8> *y_pc_buffer = new sc_bv<8>[1];
            ...
            if (i > 0) {
                ...
                for (int i_0 = 0; i_0 <= 0 ; i_0+= 1) {
                    ...
                    *(y) = (sc_bv<8>(y_pc_buffer[0 + AESL_i].range(7, 0))).to_uint64();
        ...
        sc_bv<8> x_tvin_wrapc_buffer;

        AESL_i = 0; //subscript for rtl array

        x_tvin_wrapc_buffer.range(7, 0) = x;
        ...
        AESL_ORIG_DUT_poly(x,y);

        sprintf(tvout_y, "[[transaction]] %d\n", AESL_transaction);

        aesl_fh.write(AUTOTB_TVOUT_y, tvout_y);

        sc_bv<8> *y_tvout_wrapc_buffer = new sc_bv<8>[1];

        AESL_i = 0; //subscript for rtl array

        for (int i_0 = 0; i_0 <= 0 ; i_0+= 1) {

            y_tvout_wrapc_buffer[0 + AESL_i].range(7, 0) = *(y);
