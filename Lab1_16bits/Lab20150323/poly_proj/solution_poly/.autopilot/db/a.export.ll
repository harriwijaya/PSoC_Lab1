...
define void @poly(i16 signext %x, i16* %y) nounwind uwtable {
  ...
  %tmp_3 = shl i16 %x_read, 2
  %tmp_1 = sub i16 %tmp_3, %x_read
  %tmp = add i16 %tmp_1, 2
  %tmp1 = mul i16 %tmp, %x_read
  %tmp_2 = add i16 %tmp1, 1
  call void @_ssdm_op_Write.ap_auto.i16P(i16* %y, i16 %tmp_2) nounwind
  ret void
}
