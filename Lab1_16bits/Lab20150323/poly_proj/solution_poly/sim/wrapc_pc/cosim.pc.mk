...
AUTOPILOT_ROOT := /opt/Xilinx/Vivado_HLS/2013.4
...
IFLAG += -fPIC
ifndef AP_GCC_PATH
  AP_GCC_PATH := /opt/Xilinx/Vivado_HLS/2013.4/lnx64/tools/gcc/bin
endif
...
$(ObjDir)/lab1.c_pre.c.tb.o: lab1.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling(apcc) lab1.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb)  $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@ ; \
