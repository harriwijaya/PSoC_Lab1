; ModuleID = '/home/harri001/Lab1_32bits/poly_proj/solution_poly/.autopilot/db/a.g.1.bc'
...
define void @poly(i32 %x, i32* %y) nounwind uwtable {
  ...
  call void @llvm.dbg.value(metadata !{i32 %x}, i64 0, metadata !13), !dbg !14 ; [debug line = 1:15] [debug variable = x]
  call void @llvm.dbg.value(metadata !{i32* %y}, i64 0, metadata !15), !dbg !16 ; [debug line = 1:24] [debug variable = y]
  %tmp.1 = mul i32 %x, 3, !dbg !17                ; [#uses=1 type=i32] [debug line = 3:2]
  %tmp = add i32 %tmp.1, 2                        ; [#uses=1 type=i32]
  %tmp1 = mul i32 %tmp, %x                        ; [#uses=1 type=i32]
  %tmp.2 = add nsw i32 %tmp1, 1, !dbg !17         ; [#uses=1 type=i32] [debug line = 3:2]
  store i32 %tmp.2, i32* %y, align 4, !dbg !17    ; [debug line = 3:2]
...
!14 = metadata !{i32 1, i32 15, metadata !5, null}
!15 = metadata !{i32 786689, metadata !5, metadata !"y", metadata !6, i32 33554433, metadata !10, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!16 = metadata !{i32 1, i32 24, metadata !5, null}
!17 = metadata !{i32 3, i32 2, metadata !18, null}
!18 = metadata !{i32 786443, metadata !5, i32 1, i32 27, metadata !6, i32 0} ; [ DW_TAG_lexical_block ]
